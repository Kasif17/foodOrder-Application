...
export default function Cart() {
  ...
  return (
    <div>
      ...
      {console.log(data)}
      <div className="text-success table-responsive-md table-responsive-sm mt-5 table-responsiv container m-auto">
          ...
          <tbody>
            {data.map((food, index) => (
              <tr>
                ...
                <td>{food.size}</td>
                <td>{food.price}</td>
                <td ><button type="button" className="btn p-0"><h3 className='text-danger'  onClick={() => { dispatch({ type: "REMOVE", index: index }) }}>X</h3></button> </td></tr>
            ))}
          </tbody>
        </table>
